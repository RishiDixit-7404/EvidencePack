...
CONTROLS = [
    (
        "AM-01",
        "Quarterly user access reviews are performed and retained.",
        "Access review evidence",
        "Access Management",
    ),
    (
        "AM-02",
        "Terminated user access is removed within 24 hours.",
        "Termination ticket or access export",
        "Access Management",
    ),
    (
        "AM-03",
        "Privileged access is approved and limited to authorized administrators.",
        "Admin access approval",
        "Access Management",
    ),
    (
        "AM-04",
        "Password standards require complexity, rotation, and lockout controls.",
        "Access policy",
        "Access Management",
    ),
    (
        "CM-01",
        "Production changes are documented in approved change tickets.",
        "Change ticket",
        "Change Management",
    ),
    (
        "CM-02",
        "Emergency changes receive retrospective review and approval.",
        "Emergency change review",
        "Change Management",
    ),
    (
        "CM-03",
        "Change testing evidence is retained before implementation.",
        "Testing evidence",
        "Change Management",
    ),
    (
        "CM-04",
        "Segregation of duties is maintained between request, approval, and deployment.",
        "Change approval log",
        "Change Management",
    ),
    (
        "DP-01",
        "Sensitive data is encrypted at rest in approved storage locations.",
        "Encryption configuration",
        "Data Protection",
    ),
    (
        "DP-02",
        "Backups are monitored and restoration tests are performed periodically.",
        "Backup and restore evidence",
        "Data Protection",
    ),
    (
        "DP-03",
        "Firewall rules are reviewed for unnecessary inbound access.",
        "Firewall rules export",
        "Data Protection",
    ),
    (
        "DP-04",
        "Security incidents are tracked, triaged, and closed with documented resolution.",
        "Incident ticket",
        "Data Protection",
    ),
]
